...
export const dashboardRoutes: NavRoute[] = [
  ...
  { title: "Service Requests", href: "/dashboard/requests", icon: BriefcaseBusiness },
  {
    ...
    children: [
      { title: "Service Categories", href: "/dashboard/service-categories", icon: FolderTree },
      { title: "Pricing & Services", href: "/dashboard/pricing-services", icon: Receipt },
      { title: "Commissions", href: "/dashboard/commissions", icon: Percent },
      { title: "Operational Settings", href: "/dashboard/operational-settings", icon: Settings2 },
    ],
  },
